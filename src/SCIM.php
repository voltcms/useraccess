...
class SCIM
{
    ...
    public function getUser($userID, $isIncluded = '')
    {
        ...
        // header("Last-Modified: " . gmdate("D, d M Y H:i:s", $payload['meta']['lastModified']) . " GMT");
        header("Last-Modified: " . $payload['meta']['lastModified'] . " GMT");
